...
#define _PROCESS_FLAG_FORK	0x00000010
#define _PROCESS_FLAG_USER_EXEC	0x00000020
#define _PROCESS_FLAG_KERN_EXEC	0x00000040

#define PROCESS_FLAG_USER_EXEC	(_PROCESS_FLAG_USER_EXEC | PROCESS_TYPE_USER)
#define PROCESS_FLAG_KERN_EXEC	(_PROCESS_FLAG_KERN_EXEC | PROCESS_TYPE_USER)
#define PROCESS_FLAG_FORK	(_PROCESS_FLAG_FORK)
