...
#define KERNEL_VIRTUAL_SIZE	(632 * 1024 * 1024)

#define KERNEL_DMA_BASE		(KERNEL_VIRTUAL_BASE + KERNEL_VIRTUAL_SIZE)
#define KERNEL_DMA_SIZE		(64 * 1024 * 1024)
...
#define KERNEL_TEMP_BUFFER_SIZE	(4 * 1024 * 1024)

#define KERNEL_ARCH_BASE	(KERNEL_TEMP_BUFFER_BASE + KERNEL_TEMP_BUFFER_SIZE)
#define KERNEL_ARCH_SIZE	(4 * 1024 * 1024)
